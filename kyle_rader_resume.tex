  ...
  \cventry
    ...
    {July 2016 - PRESENT $\cdot$ 1 yr 7 mos} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item Pioneered use of Docker/Docker-Compose standardizing developer environments. Solved ``works on my machine" problem.
        \item Designed a Neo4j on Docker toolkit for management and orchestration of Neo4j instances on Joyent's Triton platform.
